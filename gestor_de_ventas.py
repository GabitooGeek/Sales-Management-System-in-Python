...
def boton_ventas():
    ...
    f_autor.place_forget()
    l_image_vestido_nar.place_forget()
    l_image_vestido_neg.place_forget()
    l_image_vestido_ver.place_forget()
...
fr_marco_vender = customtkinter.CTkFrame(ventana_ini, width=500, height=250, fg_color="gray", corner_radius=10)

lb_id_producto = customtkinter.CTkLabel(fr_marco_vender, text="ID Producto:", text_color="black", font=("Arial", 30, "bold")) 
lb_id_producto.place(relx=0.3, rely=0.1, anchor="center")

lb_cant_producto = customtkinter.CTkLabel(fr_marco_vender, text="Cantidad:", text_color="black", font=("Arial", 30, "bold"))
lb_cant_producto.place(relx=0.3, rely=0.3, anchor="center")

nombre_del_producto = tkinter.StringVar(value="Nombre")
lb_nombre_producto = customtkinter.CTkLabel(fr_marco_vender, textvariable= nombre_del_producto, text_color="blue", font=("Arial", 25, "bold"))
lb_nombre_producto.place(relx=0.3, rely=0.5, anchor="center")

precio_producto = tkinter.StringVar(value="Precio: $0.0")
lb_precio = customtkinter.CTkLabel(fr_marco_vender, textvariable=precio_producto, text_color="blue", font=("Arial", 30, "bold")) 
lb_precio.place(relx=0.3, rely=0.7, anchor="center")

total_compra = tkinter.StringVar(value="Total: $0.0")
lb_total = customtkinter.CTkLabel(fr_marco_vender, textvariable=total_compra, text_color="lime", font=("Arial", 30, "bold"))
lb_total.place(relx=0.3, rely=0.9, anchor="center")

id_prod_entry = customtkinter.CTkEntry(fr_marco_vender, width=150, height=25, corner_radius=10, text_color="black", font=("Arial", 15, "bold"))
id_prod_entry.place(relx=0.75, rely=0.1, anchor="center")

can_prod_entry = customtkinter.CTkEntry(fr_marco_vender, width=150, height=25, corner_radius=10, text_color="black", font=("Arial", 15, "bold"))
can_prod_entry.place(relx=0.75, rely=0.3, anchor="center")

boton_enter_pro = customtkinter.CTkButton(fr_marco_vender, width=100, height=50, font=("Arial",40,"bold"),corner_radius=10, text="Enter", command=obtener_producto_info)
boton_enter_pro.place(relx=0.65, rely=0.55)

fr_compra_reali = customtkinter.CTkFrame(ventana_ini, width=500, height=150, fg_color="gray", corner_radius=10)

compra_detalle = tkinter.StringVar(value="Detalles de tu compra")

lb_compra_realizada = customtkinter.CTkLabel(fr_compra_reali, textvariable= compra_detalle, font=("Arial",40,"bold"), text_color="MediumSpringGreen")
